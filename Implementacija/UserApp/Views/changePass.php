            ...
            <div class="row vh-100">
                <div class="col-sm-12 d-flex justify-content-center align-items-center bg-white text-center">
                    <div class="shadow-lg p-4 mb-4 bg-ligt">
                        ...
                        ?>
                        <form name="changePassForm" action="<?= site_url("Korisnik/changePassword") ?>" method="post" class="needs-validation" novalidate style="width:400px">
                            <div class="form-group">
                                <input type="password" class="form-control" id="pswd" placeholder="Nova lozinka" name="pswd" required>
                                <div class="invalid-feedback text-sm-left">Lozinka ne sme biti prazno polje</div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="pswdC" placeholder="Potvrda lozinke" name="pswdC" required>
                                <div class="invalid-feedback text-sm-left">Potvrda lozinke ne sme biti prazno polje</div>
                            </div>
                            <button type="submit" class="btn btn-primary">Promena lozinke</button>
                        </form>
                    </div>
                </div>
            </div>      
