            ...
            <div class="row vh-100">
                <div class="col-sm-12 d-flex justify-content-center align-items-center bg-white text-center">
                    <div class="shadow-lg p-4 mb-4 bg-ligt">
                        <form name="loginForm" action="<?= site_url("Korisnik/loginSubmit") ?>" method="post" class="needs-validation" novalidate style="width:400px">
                            ...
                            <div class="form-group text-left">
                                <a href="<?= site_url("Korisnik/recoverPass") ?>">Zaboravljena lozinka?</a>
                            </div>
                            <button type="submit" class="btn btn-primary">Uloguj se</button>
                            <hr>
                            <div class="form-group">
                                <a href="<?= site_url("Korisnik/register") ?>">Nemate nalog? Registrujte se ovde</a>
                            </div>
                        </form>
                    </div>
                </div>
