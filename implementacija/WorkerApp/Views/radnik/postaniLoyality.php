...
<html lang="en">
    <head>
        ...
        <title>Registracija Loyality Korisnika</title>
    ...
    <body style="overflow-x: hidden;">
        ...
        <form class="needs-validation" novalidate name="loginform" action="<?= site_url("Radnik/postaniLoyality") ?>" method="post">
        <div class="row mt-3">
            <div class="offset-sm-3 col-sm-6 ">
                <table class="table table-borderless" width="100%">
                    ...
                    <tr>
                        <td width="50%" align="center">
                            <input name="loyality" type="submit" class="btn btn-dark btn-lg btn-outline-light" value="Unesi Loyality"></input>
                        </td> 
                    </tr>
                </table>   
            </div>
